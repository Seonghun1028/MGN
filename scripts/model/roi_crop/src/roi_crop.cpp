...
int BilinearSamplerBHWD_updateOutput(at::Tensor inputImages, at::Tensor grids, at::Tensor output)
{
...
int BilinearSamplerBHWD_updateGradInput(at::Tensor inputImages, at::Tensor grids, at::Tensor gradInputImages,
...
int BilinearSamplerBCHW_updateOutput(at::Tensor inputImages, at::Tensor grids, at::Tensor output)
{
...
int BilinearSamplerBCHW_updateGradInput(at::Tensor inputImages, at::Tensor grids, at::Tensor gradInputImages,
                                        at::Tensor gradGrids, at::Tensor gradOutput)
{
  bool onlyGrid=false;
