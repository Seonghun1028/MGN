...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    return nn.Conv2d(int(in_planes), int(out_planes), kernel_size=3, stride=stride,          #### int 추가 ####
                     padding=1, bias=False)

def conv1x1(in_planes, out_planes, stride=1):                                                #### conv1x1 추가 ####
    """1x1 convolution"""
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes: int, planes, stride: int=1, downsample=None):
